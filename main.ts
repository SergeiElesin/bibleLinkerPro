		...
		const convertBibleTextToJWLibraryLink = (
			...
			try {
				...
				const bibleBooksRU = [
					...
					["ин", "иоан", "иоанна"],
					["дн", "деян", "деяния"],
					["рм", "рим", "римл", "римлянам"],
					["1кр", "1кор", "1коринфянам"],
					["2кр", "2кор", "2коринфянам"],
					["гл", "гал", "галатам"],
					["эф", "эфес", "эфесянам"],
					["фп", "фил", "филиппийцам"],
					["кл", "кол", "колос", "колоссянам"],
					["1фс", "1фесс", "1фессалоникийцам"],
					["2фс", "2фесс", "1фессалоникийцам"],
					["1тм", "1тим", "1тимофею"],
					["2тм", "2тим", "2тимофею"],
					["тит", "титу"],
					["фм", "флм", "филим", "филимону"],
					["ев", "евр", "евреям"],
					["ик", "иак", "иакова"],
					["1пт", "1пет", "1петра"],
					["2пт", "2пет", "2петра"],
